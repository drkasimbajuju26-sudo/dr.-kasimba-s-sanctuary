...
const services = [
  ...
  {
    icon: Search,
    imagePath: "/services/JOB-SPELL-Get-a-Job-Employment-Career-Magic-Dream-Job-1024x768.webp",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, i) => (
            ...
            >
              <div className="mb-8">
                <img className="h-72 object-cover w-full" src={service.imagePath} alt={service.title} />
              </div>
